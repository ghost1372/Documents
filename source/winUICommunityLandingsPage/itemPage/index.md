...
this is a Built-in Page for showing Pages with a Header, you can navigate to this page for showing your desired page. 
...
```cs
Navigate(typeof(ItemPage), UniqueId);
```
...
if you want to play with some properties, you can add ItemPage in a Page and set some of Properties.

```xml
<Page
    x:Class="WinUICommunity.DemoApp.Pages.ItemPage"
    ...
    <controls:ItemPage x:Name="itemPage" DocumentationDropDownText="Documentation">
        <controls:ItemPage.HeaderLeftContent>
            <DropDownButton ToolTipService.ToolTip="Source code">
        ...
        <controls:ItemPage.HeaderRightContent>
...
{% note warning %}
It is very important that you modify it where you navigate to the ItemPage and replace it with the new ItemPage you created!
{% endnote %}

```cs
Navigate(typeof(myItemPage), UniqueId);
```


![LandingsPage](https://raw.githubusercontent.com/ghost1372/Resources/main/LandingsPage/ItemPage.png)