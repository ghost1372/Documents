...
{
    mainLandingPage.GetDataAsync("DataModel/ControlInfoData.json", PathType.Relative);
}
```
...
```cs
mainLandingPage.GetDataAsync("DataModel/ControlInfoData.json", PathType.Relative, IncludedInBuildMode.RealCheckBasedOnUniqeIdPath);
```
